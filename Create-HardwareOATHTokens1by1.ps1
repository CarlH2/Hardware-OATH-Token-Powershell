<#  ==============================================================================================================================================
    Create-HardwareOATHTokens1by1.ps1:  From a CSV file taken as a script parameter this script
                                    creates unassigned and unactivated Hardware OATH token object(s) in Entra ID one at a time using the POST method
    Usage:
    ======
        .\Create-HardwareOATHTokens1by1.ps1 -csvFilePath <PathToYourCSV>
        
        e.g. .\Create-HardwareOATHTokens1by1.ps1 -csvFilePath .\temp\HardwareOATHTokenList.csv
   ...
   Output:
   =======
   The script writes to a Log named Create-HardwareOATHTokens1by1.log in the current folder
...
# Start Logging
start-transcript .\Create-HardwareOATHTokens1by1.Log -Append -Force
